...
| Слой | Технологии |
|------|-----------|
| Frontend | React 19, TypeScript, Vite, Yandex Maps JS API 3.0, Zustand, Socket.io |
...
| `YANDEX_MAPS_API_KEY` | — | Ключ JS API Яндекс Карт ([получить](https://developer.tech.yandex.ru/)) |
